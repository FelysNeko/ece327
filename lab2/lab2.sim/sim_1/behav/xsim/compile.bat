...
REM
REM Generated by Vivado on Thu Jun 11 11:36:49 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj wordle_top_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj wordle_top_tb_vlog.prj -log xvlog.log
