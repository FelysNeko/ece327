...
REM
REM Generated by Vivado on Sun Jul 26 14:51:50 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj mvm_tb_bonus128_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mvm_tb_bonus128_vlog.prj -log xvlog.log
