...
REM
REM Generated by Vivado on Fri Jul 03 16:20:41 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tanh_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tanh_tb_vlog.prj -log xvlog.log
