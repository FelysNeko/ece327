...
//Date        : Fri Jun 12 12:02:29 2026
//Host        : ECE-MCU2-21 running 64-bit major release  (build 9200)
//Command     : generate_target wordle_design.bd
//Design      : wordle_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "wordle_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=wordle_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_clkrst_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "wordle_design.hwdef" *) 
module wordle_design
   ();
  ...
  wire [3:0]guess_id_gpio_io_o;
  wire [31:0]guess_word_gpio_io_o;
  wire [9:0]ref_word_idx_gpio_io_o;
  wire [0:0]rst_ps8_0_99M_peripheral_aresetn;
  wire [1:0]wordle_top_0_o_game_status;
  wire [3:0]wordle_top_0_o_guess_count;
  wire wordle_top_0_o_ready;
  wire [7:0]wordle_top_0_o_result;
  ...
  wordle_design_axi_smc_0 axi_smc
  ...
  wordle_design_axi_gpio_6_0 game_status
       (.gpio_io_i(wordle_top_0_o_game_status),
  ...
  wordle_design_axi_gpio_5_0 guess_count
       (.gpio_io_i(wordle_top_0_o_guess_count),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  wordle_design_axi_gpio_2_0 guess_id
       (.gpio_io_o(guess_id_gpio_io_o),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  wordle_design_axi_gpio_1_0 guess_word
       (.gpio_io_o(guess_word_gpio_io_o),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  wordle_design_axi_gpio_3_0 ready
       (.gpio_io_i(wordle_top_0_o_ready),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  wordle_design_axi_gpio_0_0 ref_word_idx
       (.gpio_io_o(ref_word_idx_gpio_io_o),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  wordle_design_axi_gpio_4_0 result
       (.gpio_io_i(wordle_top_0_o_result),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  wordle_design_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  wordle_design_wordle_top_0_0 wordle_top_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .i_guess_id(guess_id_gpio_io_o),
        .i_guess_word(guess_word_gpio_io_o),
        .i_ref_word_idx(ref_word_idx_gpio_io_o),
        .o_game_status(wordle_top_0_o_game_status),
        .o_guess_count(wordle_top_0_o_guess_count),
        .o_ready(wordle_top_0_o_ready),
        .o_result(wordle_top_0_o_result),
        .rstn(rst_ps8_0_99M_peripheral_aresetn));
  wordle_design_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
