...
#
# Script generated by Vivado on Tue Jun 02 10:30:59 -0400 2026
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : alu_design.sh
...
#
# Usage        : alu_design.sh
#                alu_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                alu_design.sh [-reset_run]
#                alu_design.sh [-reset_log]
#                alu_design.sh [-help]
#
...
export RDI_DATADIR="C:/Software/Xilinx/Vivado/2024.2/data"
...
# script info
echo -e "alu_design.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./alu_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_20 -L zynq_ultra_ps_e_vip_v1_0_20 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_36 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_register_slice_v2_1_34 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot alu_design xil_defaultlib.alu_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim alu_design -key {Behavioral:sim_1:Functional:alu_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f990.protoinst" -protoinst "protoinst_files/alu_design.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Software/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb alu_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./alu_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: alu_design.sh [-help]\n\
Usage: alu_design.sh [-step]\n\
Usage: alu_design.sh [-lib_map_path]\n\
Usage: alu_design.sh [-reset_run]\n\
Usage: alu_design.sh [-reset_log]\n\
Usage: alu_design.sh [-keep_index]\n\
Usage: alu_design.sh [-noclean_files]\n\n\
