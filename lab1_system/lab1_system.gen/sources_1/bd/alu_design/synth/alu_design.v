...
//Date        : Tue Jun  2 10:30:23 2026
//Host        : ECE-MCU2-09 running 64-bit major release  (build 9200)
//Command     : generate_target alu_design.bd
//Design      : alu_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "alu_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=alu_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=8,da_clkrst_cnt=2,da_zynq_ultra_ps_e_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "alu_design.hwdef" *) 
module alu_design
   ();

  wire [31:0]alu_0_o_result;
  ...
  wire [31:0]dataa_gpio_io_o;
  wire [31:0]datab_gpio_io_o;
  wire [1:0]op_gpio_io_o;
  ...
  alu_design_alu_0_1 alu_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .i_dataa(dataa_gpio_io_o),
        .i_datab(datab_gpio_io_o),
        .i_op(op_gpio_io_o),
        .o_result(alu_0_o_result),
        .rstn(rst_ps8_0_99M_peripheral_aresetn));
  alu_design_axi_smc_1 axi_smc
  ...
  alu_design_axi_gpio_0_1 dataa
       (.gpio_io_o(dataa_gpio_io_o),
  ...
  alu_design_axi_gpio_1_1 datab
       (.gpio_io_o(datab_gpio_io_o),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  alu_design_axi_gpio_2_1 op
       (.gpio_io_o(op_gpio_io_o),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  alu_design_axi_gpio_3_1 result
       (.gpio_io_i(alu_0_o_result),
        .s_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  alu_design_rst_ps8_0_99M_1 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  alu_design_zynq_ultra_ps_e_0_1 zynq_ultra_ps_e_0
